...
//   static const String auragen = '/auragen';
//   static const String lyrics = '/lyrics';
//   static const String lyricsEdit = '/lyrics/:trackId/edit';
//   static const String lyricsEdit = '/lyrics/edit';
//   static const String remix = '/remix';
//   static const String stem = '/stem';
//   static const String sync = '/sync';
...
import 'package:aurabeat/screens/sync/sync_screen.dart';
import 'package:aurabeat/screens/analytics/analytics_screen.dart';
import 'package:aurabeat/models/track_model.dart';
...
class AppRoutes {
  ...
  static const String auragen = '/auragen';
  static const String lyrics = '/lyrics';
  static const String lyricsEdit = '/lyrics/:trackId/edit';  // Fixed path parameter
  static const String remix = '/remix';
  static const String stem = '/stem';
  static const String sync = '/sync';
  static const String analytics = '/analytics';
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      // Fixed lyrics edit route with path parameter
      GoRoute(
        path: '/lyrics/:trackId/edit',
        builder: (context, state) {
          final trackId = state.pathParameters['trackId'];  // Get from path parameters
          final track = state.extra as Track?; //cast to Track
          //final track = state.extra;  // Get track from extra data
          debugPrint('Routing to LyricsEditScreen with trackId: $trackId, track: $track');
          return LyricsEditScreen(
            trackId: trackId,
            track: track,  // Pass the track object if your LyricsEditScreen accepts it
          );
        },
      ),
      GoRoute(
  ...
  // Helper method to generate lyrics edit path
  static String lyricsEditPath(String trackId) {
    return '/lyrics/$trackId/edit';
  }
